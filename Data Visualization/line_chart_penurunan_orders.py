...
# Menampilkan 5 baris pertama dari monthly_orders_df
...
plt.plot(
    monthly_orders_df["order_date"],   # Menggunakan kolom 'month' yang sudah diubah menjadi nama bulan
...
plt.xticks(rotation=45, fontsize=10)  # Rotasi agar label bulan lebih terbaca
